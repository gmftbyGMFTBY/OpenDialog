...
TODO
1. test the performance of the filter
2. test the performance of training on the replay memory
'''
...
class GPT2RL_V2(nn.Module):
    ...
    def reset_target_discriminator(self):
        ...
        print(f'[!] reset the target discriminator')
    ...
    def forward(self, cid, rid=None, max_size=None, mode='gen_rl'):
        ...
        if mode == 'gen_rl':
            ...
            if rid is None:
                raise Exception(f'[!] rid must not be NoneType for target_dis mode')
            cid = torch.cat((cid, rid), dim=1)
...
class GPT2RLAgent_V2(BaseAgent):
    ...
    def __init__(self, multi_gpu, vocab_file='data/vocab/vocab_small', run_mode='train'):
        ...
        self.args = {
            ...
            'dis_pretrained_model': 'debug_dis.pt', 
            'rollout_samples': 2,
    ...
    def train_discriminator_(self, cid, rid, fake=False):
        ...
        cr_label = (score > self.args['filter_threshold']).long()
